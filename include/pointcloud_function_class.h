...
protected:
  ...
  ros::Publisher bounding_pub = bounding_box_publisher.advertise<visualization_msgs::Marker> ( "/magneto_autonomy/bounding_boxes_marker", 1 );;
  ros::Publisher xyz_pub = perception_publisher.advertise< geometry_msgs::Vector3 >( "/magneto_autonomy/scan_result", 1);
  ros::Publisher vis_pub = perception_publisher.advertise<visualization_msgs::Marker>( "/magneto_autonomy/visualization_marker", 1 );
  ros::Publisher slam_pub = perception_publisher.advertise<visualization_msgs::Marker>( "/magneto_autonomy/slam_map_beta", 1 );
};